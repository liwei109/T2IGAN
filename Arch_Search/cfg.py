...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help='captions per image')
    parser.add_argument(
        '--words_num',
        type=int,
        default=18,
        help='words num per sentence')
    parser.add_argument(
        '--base_imgsize',
        type=int,
        default=64,
    ...
    parser.add_argument(
        '--Net_E',
        type=str,
        default='./DAMSMencoders/bird/text_encoder200.pth',
        help='text_encoder')
    ...
    # search
    parser.add_argument('--shared_epoch', type=int, default=15, # 15
                        help='the number of epoch to train the shared gan at each search iteration')
    parser.add_argument('--grow_step1', type=int, default=15, # 25
                        help='which iteration to grow the image size from 8 to 16')
    parser.add_argument('--grow_step2', type=int, default=35, # 55
                        help='which iteration to grow the image size from 16 to 32')
    parser.add_argument('--grow_step3', type=int, default=60, 
                        help='which iteration to grow the image size from 32 to 64')
    parser.add_argument('--max_search_iter', type=int, default=90, # 90
                        help='max search iterations of this algorithm')
    parser.add_argument('--ctrl_step', type=int, default=30, # 30
