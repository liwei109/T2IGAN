...
from models_search.TransformerBlock import TransEncoderBlock
...
class Cell(nn.Module):
    def __init__(self, in_channels, out_channels, num_skip_in, hw, ksize=3):
        ...
        self.conv1 = ConvBlock(in_channels, out_channels, ksize=ksize, up_block=True)
        ...
        self.conv2 = ConvBlock(out_channels, out_channels, ksize=ksize, up_block=False)
