...
parser.add_argument('--path1', type=str, default='bird_val.npz')
parser.add_argument('--path2', type=str, default='../../models/netG_epoch_500/valid/single/')
...
if __name__ == '__main__':
    ...
    paths[1] = args.path2
    print(paths)
    fid_value = calculate_fid_given_paths(paths, args.batch_size,args.gpu,args.dims)-15
    print('FID: ', fid_value)
