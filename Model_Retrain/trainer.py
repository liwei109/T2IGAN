...
from model import G_DCGAN, G_NET, RNN_ENCODER, CNN_ENCODER
    ...
    def train(self):
        ...
        for epoch in range(start_epoch, self.max_epoch):
            ...
            while step < self.num_batches:
                ...
                if step % 100 == 0:
                    print('[' + str(step) + '/' + str(self.num_batches) + ']', D_logs + G_logs)
                # save images
            ...
            print('''\n[%d/%d] Loss_D: %.2f  Loss_G: %.2f  Time: %.2fs\n''' % (epoch, self.max_epoch,
        ...
        if cfg.TRAIN.NET_G == '':
            ...
            for key in data_dic:
                ...
                for i in range(1):  # 16
                    ...
                    # words_embs: batch_size x nef x seq_len
                    # sent_emb: batch_size x nef
                    words_embs, sent_emb = text_encoder(captions, cap_lens, hidden, cap_lens)
                    mask = (captions == 0)
                    #######################################################
                    # (2) Generate fake images
                    ######################################################
